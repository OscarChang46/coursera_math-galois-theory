...
\part{Notes}          %
% -------------- WEEK 1 -----------------
\include{week1/notes} % 22 Feb -- 28 Feb
\include{week1/quiz}  %           28 Feb
% -------------- WEEK 2 -----------------
\include{week2/notes} % 29 Feb --  6 Mar
\include{week2/quiz}  %            6 Mar
% -------------- WEEK 3 -----------------
%\include{week3/notes} %  7 Mar -- 13 Mar
%\include{week3/quiz}  %           13 Mar
% -------------- WEEK 4 -----------------
%\include{week4/notes} % 14 Mar -- 20 Mar
%\include{week4/quiz}  %           20 Mar
% -------------- WEEK 5 -----------------
%\include{week5/notes} % 21 Mar -- 27 Mar
%\include{week5/quiz}  %           27 Mar
% -------------- WEEK 6 -----------------
%\include{week6/notes} % 28 Mar --  3 Apr
%\include{week6/quiz}  %            3 Apr
% -------------- WEEK 7 -----------------
%\include{week7/notes} %  4 Apr -- 10 Apr
% -------------- WEEK 8 -----------------
%\include{week8/notes} % 11 Apr -- 17 Apr
%\include{week8/quiz}  %           17 Apr
% -------------- WEEK 9 -----------------
%\include{week9/notes} % 18 Apr -- 24 Apr
%\include{week9/quiz}  %           24 Apr

%\part{Assignments}
%\include{week3/u_assignment}
%\include{week5/g_assignment}
%\include{week7/u_assignment}
%\include{week9/g_assignment}

%\part{Exercises from Lang's ``Algebra''}
%\include{exercises/part5}
%\include{exercises/part6}
%\include{exercises/part7}
\end{document}